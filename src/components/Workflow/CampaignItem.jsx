...
export default function CampaignItem({
  ...
  return (
    ...
    >
      <Disclosure as="li" className="z-0">
        {({ open }) => (
          <>
            <Disclosure.Button
              as="div"
                            ...
                            {({ active }) => (
                              ...
                              >
                                <CheckCircleIcon
                                  ...
                                  aria-hidden="true"
                                />
                                {campaign.approved ? 'Unapprove' : 'Approve'}
                              </button>
                            )}
                          </Menu.Item>
                          {onRollback && (
                  ...
                  <div className="min-w-0 flex-1 px-4 md:grid md:grid-cols-2 md:gap-4">
                    <div>
                      ...
                      <p className="mt-2 flex items-center text-sm text-gray-500">
                        <span className="truncate">{campaign.promoId}</span>
                      </p>
                    </div>
